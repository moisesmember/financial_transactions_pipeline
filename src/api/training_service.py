...
class TrainingJobManager:
    ...
    def _training_configuration(settings: Settings) -> dict[str, Any]:
        ...
        names = (
            ...
            "min_valid_temporal_folds",
            "min_fold_recall_candidate",
            "min_last_fold_recall_candidate",
            "min_pr_auc_lift_over_random",
            "max_temporal_alert_rate",
            "max_pr_auc_temporal_drop",
            "max_recall_temporal_drop",
            ...
            "training_max_rows",
            "raw_data_max_rows",
            "preserve_all_positives",
            "negative_sampling_enabled",
            "negative_sampling_strategy",
            "negative_sampling_by",
            "training_negative_positive_ratio",
            "sampling_enforce_fixed_ratio",
            "imbalance_strategy",
